...
if __name__ == '__main__':
    ...
    trainer = Trainer()
    print('---',args)
    trainer.train(model, vocab, train_loader, valid_loader_list, loss_type, start_epoch, num_epochs, args,evaluate_every=1000, opt_name="adam",save_every=args.save_every)
